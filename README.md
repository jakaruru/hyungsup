...
저는 솔로몬텍㈜ 소속으로 현대케피코에 파견되어 상주근무하며 Java Spring, ASP.NET, RDBMS, RESTful API, GraphQL 등 폭넓은 기술 스택을 활용했습니다. <br />
...
| **API** | RESTful, GraphQL                   | 발생하는 문제의 원인을 스스로 분석하고, 몇 가지 대안 중 최적의 해결책을 찾아 적용할 수 있습니다. |
...
* **IM, HR 인사시스템 개발 및 운영** (2018.02-운영중)
    ...
    * **사용 스킬**: Java, Spring, RESTful API, GraphQL, MSSQL
